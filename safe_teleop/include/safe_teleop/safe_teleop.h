...
public:
  ...
  /**
   * @brief outputs current speeds to screen
   */
  void displayCurrentSpeeds() { ROS_INFO("SPEEDS - Linear: %.2g, Angular: %.2g\r", (double)linear_speed_, (double)angular_speed_); }

    /**
   * @brief outputs current velocities to screen
   */
  void displayCurrentVels() { ROS_INFO("VELOCITIES - Linear: %.2g, Angular: %.2g\r", (double)linear_vel_, (double)angular_vel_); }
